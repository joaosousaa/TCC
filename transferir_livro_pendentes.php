...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO entregues SELECT * FROM pendentes WHERE idpendentes = $livro_id";
    if (mysqli_query($con, $query)) {

        // Se o livro foi inserido com sucesso em 'entregues', delete-o da tabela 'emprestimo'
        $query = "DELETE FROM pendentes WHERE idpendentes = $livro_id";
        if (mysqli_query($con, $query)) {
...
header('Location: pendentes.php'); // Volte para a página anterior ou a página que você desejar.
?>