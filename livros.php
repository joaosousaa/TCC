                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <div class="navpaginas row">
                                ...
                                <div class="col divnav" style="height: 0vh;">
                                    <a href="livros.php" id="a1" class="animated-underline navemprestimo">ACERVO</a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="">
                                <label for="">Titulo Livro</label>
                                <p id="view_titulo" class="form-control view2"></p>
                            </div>
                            <div class="">
                                <label for="">Autor</label>
                                <p id="view_autor" class="form-control view2"></p>
                            </div>
                            <div class="">
                                <label for="">Editor</label>
                                <p id="view_editor" class="form-control view2"></p>
                            </div>
                            <div class="">
                                <label for="">Ano do Livro</label>
                                <p id="view_ano_livro" class="form-control view2"></p>
                            </div>
                            <div class="">
                                <label for="">Quantidade do Livro</label>
                                <p id="view_quantidade_livro" class="form-control view2"></p>
                            </div>
                            <div class="">
                                <label for="">Observacao</label>
                                <p id="view_observacao" class="form-control view2"></p>
                            </div>
                            <div class="">
                                <label for="">Data do Cadastro</label>
                                <p id="view_data_cadastro" class="form-control view2"></p>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
